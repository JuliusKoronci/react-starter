...
class ProfileForm extends Component {
  render() {
    const { handleSubmit, handleFileUpload, user, profileImage } = this.props;
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="uk-margin-top">
              ...
              <div className="uk-grid-margin">
                <Link className="md-btn md-btn-danger" to="/">
                  Cancel
                </Link>
