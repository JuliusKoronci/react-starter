...
class RichText extends Component {
  constructor(props, context) {
    ...
    this.state = {
      text:
        props.form && props.form[props.fieldName]
  ...
  render() {
    let val =
      this.props.form && this.props.form[this.props.fieldName]
        ? this.props.form[this.props.fieldName]
        : false;
    const value =
      val ||
      this.props.value ||
      (this.props.task && this.props.task[this.props.fieldName]
        ? this.props.task[this.props.fieldName]
        : "");
    ...
    return (
      <div>
        {this.props.label && (
          <label className="uk-text-muted">{this.props.label}</label>
        )}

        <ReactQuill
          valuee={this.state.text}
          theme="snow"
          value={value}
          modules={modules}
          formats={formats}
