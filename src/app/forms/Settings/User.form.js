  ...
  render() {
    ...
    return (
      <div className="md-card">
          ...
          <div className="md-card-content max-width-1000px">
            ...
            >
              ...
              <div className="user_avatar_controls">
                ...
                <a
                  href="#"
                  className="btn-file fileinput-exists"
            ...
            <div className="uk-margin-top">
              <h3 className="full_width_in_card heading_c">General info</h3>
              ...
              <div className="uk-grid" data-uk-grid-margin>
                ...
                <div className="uk-width-medium-1-2 uk-margin-bottom">
                  <Field
                    name="detailData.function"
                    type="text"
                    validate={[]}
                    component={renderField}
                    id="user_edit_function_control"
                    className="md-input"
                    label="User position"
                    autoComplete="off"
                  />
                ...
                <div className="uk-width-medium-1-2 uk-margin-bottom">
                  <Field
                    name="detailData.surname"
                    type="text"
                    validate={[]}
                    component={renderField}
                    id="user_edit_surname_control"
                    className="md-input"
                    label="Surname"
                    autoComplete="off"
                  />
              ...
              <h3 className="full_width_in_card heading_c">Languages</h3>
              <div className="uk-grid" data-uk-grid-margin>
                <div className="uk-width-1-1">
                  <select
                    name="language"
                    id="user_edit_languages"
                    className="md-input"
                  >
              ...
              <h3 className="full_width_in_card heading_c">Contact info</h3>
              <div className="uk-grid">
                <div className="uk-width-1-1">
                  <div
                    className="uk-grid uk-grid-width-1-1 uk-grid-width-large-1-2"
                    data-uk-grid-margin
                  >
                    ...
                    <div>
                      <div className="uk-input-group uk-margin-bottom">
                        ...
                        <Field
                          name="detailData.facebook"
                          type="text"
                          validate={[]}
                          component={renderField}
                          id="user_edit_facebook_control"
                          className="md-input"
                          label="Facebook"
                        />
                      </div>
                    ...
                    <div className="uk-input-group uk-margin-bottom">
                      ...
                      <Field
                        name="detailData.twitter"
                        type="text"
                        validate={[]}
                        component={renderField}
                        id="user_edit_twitter_control"
                        className="md-input"
                        label="Twitter"
                      />
                    </div>
                    ...
                    <div className="uk-input-group uk-margin-bottom">
                      ...
                      <Field
                        name="detailData.linkdin"
                        type="text"
                        validate={[]}
                        component={renderField}
                        id="user_edit_linkedin_control"
                        className="md-input"
                        label="Linkedin"
                      />
                    </div>
        ...
        {editing && <PasswordChangeForm params={this.props.params} />}
      </div>
    );
  }
}
...
function mapStateToProps(state, ownProps) {
  ...
  const user = state.users.data.filter(
