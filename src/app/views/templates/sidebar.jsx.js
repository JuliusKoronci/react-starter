...
const sidebar = ({
  ...
  return (
    <aside
      id="sidebar_main"
      style={sidebarIsMinified ? {} : { overflow: "auto" }}
    >
        ...
        <ul>
          ...
          <li
            className={
              sidebarIsMinified
                ? "sidebar_submenu"
                : "" + filterId ? "submenu_trigger" : "submenu_trigger "
            }
          >
            <a
              href="#"
              onClick={menuToggleActive.bind(null, "filtersOpen")}
              className={filtersOpen ? "active onHoverMenu" : "onHoverMenu"}
            >
              <span className="menu_icon">
          ...
          <li
            className={
              sidebarIsMinified
                ? "sidebar_submenu"
                : "" + projectId ? "submenu_trigger" : "submenu_trigger "
            }
          >
            <a
              href="#"
              onClick={menuToggleActive.bind(null, "projectsOpen")}
              className={projectsOpen ? "active onHoverMenu" : "onHoverMenu"}
            >
              <span className="menu_icon">
                <i className="material-icons">&#xE2C8;</i>
              </span>
            ...
            <ul>
              {projects.map((project, i) => {
                ...
                return (
                  <li key={i} className="onHoverMenu">
                    <span className="submenu-title">
                      <Link
                        to={link}
                        className={
                          parseInt(project.id, 10) === parseInt(projectId, 10)
                            ? "active md-color-deep-orange-500"
                            : ""
                        }
                      >
          ...
          <li
            className={
              sidebarIsMinified
                ? "sidebar_submenu"
                : "" + tagId ? "submenu_trigger" : "submenu_trigger act_section"
            }
          >
            <a
              href="#"
              onClick={menuToggleActive.bind(null, "tagsOpen")}
              className={tagsOpen ? "active onHoverMenu" : "onHoverMenu"}
            >
              <span className="menu_icon">
                <i className="material-icons">&#xE893;</i>
              </span>
          ...
          {loggedUserAcl.indexOf("report_filters") !== -1 && (
            ...
            >
              <a
                href="#"
                onClick={menuToggleActive.bind(null, "reportsOpen")}
                className={reportsOpen ? "active onHoverMenu" : "onHoverMenu"}
              >
                <span className="menu_icon">
                  <i className="material-icons">&#xE85C;</i>
                </span>
          ...
          >
            <a
              href="#"
              onClick={menuToggleActive.bind(null, "archivedProjectsOpen")}
              className={
                archivedProjectsOpen ? "active onHoverMenu" : "onHoverMenu"
              }
            >
              <span className="menu_icon">
                <i className="material-icons">&#xE149;</i>
