    ...
    return (
        <div className="timeline">
            ...
            {comments.map(comment=>{
                ...
                let avatar=<div className="timeline_icon timeline_icon_success"><p className="md-user-letters md-bg-cyan">{username.charAt(0)}</p></div>;
                                ...
                                <div className="uk-grid" data-uk-grid-margin>
                                    ...
                                    {!comment.email && <div className="uk-width-medium-3-4">
                                        ...
                                        <p className="uk-comment-title">
                                            {username}
                                            <span className="uk-comment-title uk-text-italic" style={{marginLeft: '10px'}}>{comment.internal?'posted a private note':'posted note'}</span>
                                        </p></div>}
