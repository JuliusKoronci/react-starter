                ...
                <div className="uk-grid">
                    <div className="uk-width-medium-1-1">
                        ...
                        <div className="uk-margin-bottom">
                            <h2 className="uk-margin-bottom">Repeat</h2>
                        </div>
                        <hr/>
                        <div className="uk-margin">
                        ...
                        <div className="uk-margin">
                            ...
                            <select id="select_demo_1" className="md-input">
                                <option value="" disabled selected hidden>select repeat time
                                </option>
                                <option value="a">minute</option>
                                <option value="a">hour</option>
                        ...
                        <div className="uk-margin">
                            <label>Repetitions number</label>
                            <input type="text" className="md-input label-fixed" value="no limit"/>
                        </div>
