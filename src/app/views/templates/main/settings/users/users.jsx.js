      ...
      <div className="md-card-content">
        ...
        <div className="uk-input-group">
          ...
          <input
            ...
            onChange={props.searchInputOnChange.bind(null)}
          />
          <span className="uk-input-group-addon">
            <button
            ...
            {props.data.map((user, i) => {
              return (
                <tr key={i}>
                  ...
                  <td>
                    {user.detailData && user.detailData.name}{" "}
                    {user.detailData && user.detailData.surname}
                  </td>
        ...
        <div className="text-allign-right">
          <Link to="/settings/users/add" className="md-btn md-btn-primary">
            Add
          </Link>
        </div>
      </div>
