        ...
        <div className="md-card">
            <div className="md-card-content">
                <div className="uk-margin-bottom" data-uk-margin>
                    <h1 className="heading_b uk-margin-bottom">Users reports</h1>
                </div>
                <hr/>
                ...
                <table className="uk-table uk-text-nowrap">
                    ...
                    <tbody>
                    <tr>
                        <td><Link to='/reports/user' className="uk-text-large">User 1</Link></td>
                        <td className="uk-text-center">10</td>
                    </tr>
                    <tr>
                        <td><Link to='/reports/user' className="uk-text-large">User 2</Link></td>
