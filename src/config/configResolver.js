...
} from "../app/redux/actions/tasks.action";
import {
  profileReceived,
  avatarUploaded
} from "../app/redux/actions/users.action";
...
class configResolver {
  ...
  static getCompanyAttributesConfig = id => {
    return {
      url: id
        ? urls.COMPANYATTRIBUTES_LIST + "/" + id
        : urls.COMPANYATTRIBUTES_LIST,
  ...
  static projectUserConfig(projectId, userId) {
    return {
      url:
        urls.BASE_URL + "/task-bundle/project/" + projectId + "/user/" + userId,
  ...
  static saveFilter(values, filterId) {
    ...
    const url = filterId
      ? urls.BASE_URL + "/task-bundle/filters/" + filterId
      : urls.BASE_URL + "/task-bundle/filters";
  ...
  static saveRememberedFilter(values) {
    const method = "POST";
    const url = urls.FILTER_REMEMBERED_SAVE;
  ...
  static resetRememberedFilter() {
    const method = "DELETE";
    const url = urls.FILTER_REMEMBERED_RESET;
