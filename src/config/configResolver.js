...
import {companyReceived, companyAttributeReceived, statusReceived, userAttributeReceived, taskAttributeReceived, imapReceived} from '../app/redux/actions/settings.action';
