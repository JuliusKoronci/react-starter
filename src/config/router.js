...
import Tasks from "../app/components/Main/Tasks/Tasks";
...
export const paths = {
  ...
  companies_attributes_edit:
    "/settings/companies-attributes/:companyAttributeId",
  ...
  <Route component={App}>
    ...
    <Route path="/" component={Main}>
      ...
      <Route
        ...
        path={paths.automated_tasks_add}
        component={AutomatedTask}
      />
      <Route
        name="automated-tasks"
        path={paths.automated_tasks}
      ...
      <Route
        name="companies-custom-field"
        path={paths.companies_attributes_add}
        component={CompaniesCustomField}
      />
      <Route
        name="companies-custom-field"
        path={paths.companies_attributes_edit}
        component={CompaniesCustomField}
      />
      <Route
        name="companies-custom-fields"
        path={paths.companies_attributes}
        component={CompaniesCustomFields}
      />
      ...
      <Route
        name="project-shared-filter"
        path={paths.project_shared_filters_add}
        component={ProjectSharedFilter}
      />
      <Route
        name="project-shared-filters"
        path={paths.project_shared_filters}
        component={ProjectSharedFilters}
      />
      ...
      <Route
        name="shared-filter"
        path={paths.shared_filters_add}
        component={SharedFilter}
      />
      <Route
        name="shared-filters"
        path={paths.shared_filters}
        component={SharedFilters}
      />
      ...
      <Route
        name="task-attribute"
        path={paths.task_attributes_add}
        component={TaskAttribute}
      />
      <Route
        name="task-attribute"
        path={paths.task_attributes_edit}
        component={TaskAttribute}
      />
      <Route
        name="task-attribute"
        path={paths.task_attributes}
      ...
      <Route
        ...
        path={paths.user_custom_fields_add}
        component={UserCustomField}
      />
      <Route
        name="user-custom-field"
        path={paths.user_custom_fields_edit}
        component={UserCustomField}
      />
      <Route
        name="user-custom-fields"
        path={paths.user_custom_fields}
        component={UserCustomFields}
      />

      <Route
        name="reports-companies"
        path={paths.reports_companies}
        component={ReportsCompanies}
      />
      <Route
        name="report-company"
        path={paths.report_company}
        component={ReportCompany}
      />

      <Route
        name="reports-users"
        path={paths.reports_users}
        component={ReportsUsers}
      />
      <Route
        name="report-user"
        path={paths.report_user}
        component={ReportUser}
      />

      <Route
        name="reports-custom"
        path={paths.reports_custom}
